    ...
    <div className="min-h-screen container mx-auto">
      <div class="container mx-auto px-4 py-20 md:px-6 lg:px-8">
        <div class="mb-6 flex items-center justify-between">
          <div data-id="3">
            <h1 class="text-2xl font-bold" data-id="4">
              {filteredProduct[0]?.brand?.brand}
            </h1>
            <p class="text-gray-500 " data-id="5">
        ...
        <div class="container mx-auto grid grid-cols-2  md:grid-cols-3 lg:grid-cols-4 gap-6">
          {isLoading
            ? Array(8)
              ...
              .map((item) => {
                return (
                  <div class="w-80 bg-gray-50 animate-pulse shadow-md rounded-md p-3 space-y-3">
            ...
            : Array.isArray(filteredProduct) && filteredProduct?.length > 0
              ? filteredProduct?.map((el, id) => {
                return (
                  ...
                  //       onClick={() => {
                  //         dispatch(
                  //           addToCart({ productId: el?._id, ...el, ...price })
                  //         );
                  //       }}
                  //     >
                  //       <div className="mr-1">
                  ...
                  //   </div>
                  // </div>
                  <ProductSupportingComponent el={el} />
                );
              })
              : "No Data Found"}
        </div>
