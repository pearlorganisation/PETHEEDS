...
export const OrderList = () => {
        ...
        return (
                <div className="mx-auto my-8 max-w-6xl px-2 md:my-20 md:px-10">
                                ...
                                {Array.isArray(ordersData) &&
                                        ...
                                        (
                                                <div className="px-5 py-5 space-y-2">
                                                        ...
                                                        <div className="flex justify-between items-center  bg-white px-3 py-2 "><StarRating totalStars={5} /> <button onClick={() => {
                                                                setOrder(item)
                                                                setOpenReview(true)
                                                        }} className=" text-blue-600 font-semibold">Write a Review</button> </div>
                                                </div>
                        ...
                        {
                                openReview && createPortal(<ReviewModal order={order} setOpenReview={setOpenReview} />, document.body)
                        }
                </div>
