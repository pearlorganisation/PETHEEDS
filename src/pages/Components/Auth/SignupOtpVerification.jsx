                    ...
                    {[1, 2, 3, 4, 5, 6].map((index) => (
                      <div key={index} className="w-14 h-16 ">
                        <input
                          ...
                          className={`w-full h-full  text-center outline-none rounded-xl border border-gray-200 text-lg bg-white focus:bg-gray-50 focus:ring-1 ring-blue-700 ${errors[`otp${index}`] ? "border-red-500" : ""
                            }`}
                          type="text"
                          placeholder="*"
                          maxLength={1}
