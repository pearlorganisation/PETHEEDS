          ...
          <div class="w-full h-full  rounded-lg bg-white p-5  lg:rounded-l-none dark:bg-gray-700">
            ...
            >
              ...
              <div class="mb-6 text-center">
                <button class="focus:shadow-outline w-full rounded-full bg-blue-500 px-4 py-2 font-bold text-white hover:bg-blue-700 focus:outline-none dark:bg-blue-700 dark:text-white dark:hover:bg-blue-900">
